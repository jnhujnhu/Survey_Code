...
namespace grad_desc_sparse {
    ...
    double* GD(double* X, double* Y, size_t* Jc, size_t* Ir, size_t N, blackbox* model, size_t iteration_no = 10000
        , double L = 1.0, double step_size = 1.0, bool is_store_weight = false
        , bool is_debug_mode = false, bool is_store_result = false);
    double* SGD(double* X, double* Y, size_t* Jc, size_t* Ir, size_t N, blackbox* model, size_t iteration_no = 10000
        , double L = 1.0, double step_size = 1.0, bool is_store_weight = false, bool is_debug_mode = false
    ...
    std::vector<double>* Prox_SVRG(double* X, double* Y, size_t* Jc, size_t* Ir, size_t N, blackbox* model, size_t iteration_no
        , int Mode = 1, double L = 1.0, double step_size = 1.0, bool is_store_weight = false, bool is_debug_mode = false
        , bool is_store_result = false);
    std::vector<double>* Katyusha(double* X, double* Y, size_t* Jc, size_t* Ir, size_t N, blackbox* model, size_t iteration_no
